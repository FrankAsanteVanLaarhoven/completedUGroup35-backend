...
var blockComponents = require('@keystonejs/fields-content/block-components');
...
const type = 'cloudinaryImage';
const path = 'cloudinaryImages';
...
function Sidebar({
  ...
  return core.jsx(blockComponents.BlockMenuItem, {
    icon: icon,
    text: "Insert Image",
    insertBlock: () => {
      getFiles().then(files => {
...
function Node(props) {
  ...
  return core.jsx("figure", _extends({
    css: _objectSpread({
      display: 'flex',
...
function serialize({
  ...
  return {
    mutations,
    node: _objectSpread(_objectSpread({}, newNode.toJSON()), {}, {
      data: {
        align: alignment
      }
    })
