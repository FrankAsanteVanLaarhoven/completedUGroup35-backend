...
import { LinkExternalIcon, LinkIcon, CheckIcon, CircleSlashIcon } from '@primer/octicons-react';
...
function Node({
  ...
  return jsx(Fragment, null, jsx("a", _extends({}, attributes, {
    ...
    href: href
  }), children), isSelected && /*#__PURE__*/createPortal(jsx("div", {
...
let SetLinkRange = /*#__PURE__*/React.createContext(() => {});
