...
import { serialize, deserialize } from '../../../slate-serializer/dist/fields-content.esm.js';
import 'nanoassert';
import '../../../dist/slate-walker-b6b3fb8d.esm.js';
...
class ContentController extends Controller {
  constructor(_ref, ...args) {
    let {
      defaultValue = Value.fromJSON(initialValue)
    } = _ref,
    ...
    _defineProperty(this, "deserialize", data => {
      ...
      const parsedData = _objectSpread(_objectSpread({}, data[path]), {}, {
  ...
  `);
    ...
    this.getBlocks = memoizeOne(() => {
      ...
      const customBlocks = blocksModules.map(block => _objectSpread(_objectSpread({}, block), {}, {
        options: _objectSpread(_objectSpread({}, this.config.blockOptions[block.type]), {}, {
