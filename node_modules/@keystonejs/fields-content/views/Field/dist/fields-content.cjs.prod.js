...
let marks = {
  bold: {
    ...
    label: 'Bold',
    icon: props => {
      return /*#__PURE__*/React__default['default'].createElement("strong", _extends({}, props, {
        "aria-hidden": true
      }), "B");
    },
  ...
  italic: {
    ...
    label: 'Italic',
    icon: props => {
      return /*#__PURE__*/React__default['default'].createElement("em", _extends({}, props, {
        "aria-hidden": true
      }), "I");
    },
  ...
  strikethrough: {
    ...
    label: 'Strikethrough',
    icon: props => {
      return /*#__PURE__*/React__default['default'].createElement("s", _extends({}, props, {
        "aria-hidden": true
      }), "S");
    },
  ...
  underline: {
    ...
    label: 'Underline',
    icon: props => {
      return /*#__PURE__*/React__default['default'].createElement("u", _extends({}, props, {
        "aria-hidden": true
      }), "U");
    },
...
let ContentField = ({
  ...
  core.jsx(Provider, {
    ...
    autoFocus: autoFocus,
    id: htmlID,
    css: _objectSpread(_objectSpread({}, input.inputStyles({
      isMultiline: true
    })), {}, {
      padding: '0'
    }),
