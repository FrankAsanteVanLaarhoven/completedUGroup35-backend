...
import { P as ParagraphBlock, r as resolveView, B as BlockquoteBlock, H as HeadingBlock, I as ImageContainerBlock, L as LinkBlock, O as OrderedListBlock, U as UnorderedListBlock } from './unordered-list-4f6c4f5f.esm.js';
import { w as walkSlateNode } from './slate-walker-b6b3fb8d.esm.js';
import '../Block/dist/fields-content.esm.js';
import 'path';
...
async function processSerialised(document, blocks, graphQlArgs) {
  ...
  const resolvedMutations = blocks.reduce((mutations, block) => _objectSpread(_objectSpread({}, mutations), block.getMutationOperationResults(graphQlArgs)), {});
  const result = {
...
class Content$1 extends Relationship.implementation {
  constructor(path, _ref, listConfig) {
    ...
    const blockInstances = blocks.map(([block, blockConfig]) => new block(blockConfig, _objectSpread({
          ...
          async resolveInput(_ref2) {
            let {
              resolvedData
                ...
                args = _objectWithoutProperties(_ref2, ["resolvedData"]);
            ...
            return _objectSpread(_objectSpread({}, resolvedData), {}, {
    ...
    const config = _objectSpread(_objectSpread({}, fieldConfig), {}, {
      many: false,
      ref: `${type}.from`
    });
  ...
  extendAdminMeta(meta) {
    return _objectSpread(_objectSpread({}, meta), {}, {
      ...
      // client
      .reduce((options, block) => _objectSpread(_objectSpread({}, options), {}, {
  ...
  extendAdminViews(views) {
    return _objectSpread(_objectSpread({}, views), {}, {
...
class PrismaContentInterface extends Relationship.adapters.prisma {}
