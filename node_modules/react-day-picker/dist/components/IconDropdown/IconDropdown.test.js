...
beforeEach(function () {
    test_1.customRender(React.createElement(IconDropdown_1.IconDropdown, { className: "foo", style: { color: 'red' } }));
});
test('should render the icon', function () {
...
//# sourceMappingURL=IconDropdown.test.js.map